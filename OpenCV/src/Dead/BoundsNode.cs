...
namespace VVVV.Nodes.OpenCV
{
	...
	#region PluginInfo
	[PluginInfo(Name = "Bounds", Category = "OpenCV", Version = "", Help = "Returns the upper and lower bounds of the pixel values per channel", Author = "elliotwoods", Credits = "", Tags = "")]
